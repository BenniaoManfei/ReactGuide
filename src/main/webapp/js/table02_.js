        ...
        return (
            React.createElement("div", {className: "panel panel-info"}, 
                ...
                React.createElement("div", {className: "panel-body"}, 
                    ...
                    React.createElement(BootstrapTable, {header: this.props.header, data: this.state.userData, dataProps: this.props.dataProps}), 
                    React.createElement(PagePanel, {pageData: this.state.pageData})
                )
            )
        );
    }
